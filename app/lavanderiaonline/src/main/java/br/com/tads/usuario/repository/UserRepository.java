...
public class UserRepository implements UserRepositoryInterface {
    ...
    public Long createUser(UserEntity user) {
        ...
        jdbcTemplate.update(UserRepository.QUERY_CREATE,
                ...
                user.getDocument(), user.getPhone(), user.getCep(), user.getStreet(), user.getStreetNumber(),
                user.getDistrict(), user.getCity(), user.getState(), user.getBirthDate());
    ...
    public List<UserEntity> findEmployees() {
        return jdbcTemplate.query(UserRepository.QUERY_FIND_EMPLOYEES,
